...
const PARAMETER_LABELS: Record<string, string> = {
  ...
  rental_income_agreement_no_itr_no_bank: "Rental: Agreement, No ITR, Not in Bank",
  rental_income_agreement_itr_no_bank: "Rental: Agreement, ITR Filed, Not in Bank",
  rental_income_agreement_no_itr_in_bank: "Rental: Agreement, No ITR, Reflecting in Bank",
